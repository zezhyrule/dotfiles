...
clockicon:set_image("/home/zezhyrule/.config/awesome/icons/clock.png")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "Print", function () awful.util.spawn("scrot /home/zezhyrule/Pictures/screenshots/%Y-%m-%d-%T-screenshot.png") end),
