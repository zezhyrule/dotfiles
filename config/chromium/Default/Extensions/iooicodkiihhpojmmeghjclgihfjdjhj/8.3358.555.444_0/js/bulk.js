...
+				'<div class="theFont" id="login_reset__message">Your password has expired. Please reset it now.</div>'
...
//  ===========
	...
	//	======
		...
		//	reset button
		$('#dialog__clip__login_reset div.dialog_canvas').click(function() { window.open('https://www.evernote.com/Login.action?username='+encodeURIComponent($('#evernote_login__username').val())+'&targetUrl=%2FChangePassword.action%3Fv1%3Dtrue'); return false; });
    ...
    //  =============
		...
		switch (_event_name)
		{
            ...
            case 'to-browser--evernote-speech-start':
                //  track
                $R.customEvents.dispatchByName('to-extension--track--speech');
